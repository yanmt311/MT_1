...
//int main()
//{
//	char* p = "hello bit.";//"hello bit."存到指针变量中，char* 为指针变量的类型
//	printf("%s\n", p);//打印指针变量，%s打印字符串，指针变量均为四个字节。
//	return 0;
//}
...
//
//1、窗口快捷键---凡跟窗口挂上钩的快捷键必有一个W（Windows）；
...
//
//2、项目功能快捷键---规律：ctrl是强制功能键、shift有给项目增加功能
...
//CTRL + SHIFT + PAGE UP： CTRL + SHIFT + PAGE DOWN选择至本页后面
